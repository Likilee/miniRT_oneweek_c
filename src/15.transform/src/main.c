...
int	main(void)
{
	...
	objects = object(LIGHT, light(point3(6, 3, -0.5), color3(120, 100, 100)), NULL);
	oadd(&objects, object(LIGHT, light(point3(-2, -2, -0.5), color3(13, 13, 13)), NULL));
	...
	trans = transform(vec3(1,1,1), vec3(0,0,0), vec3(2,0,0));
	oadd(&objects, object(CY, cylinder(point3(0,-1,-2.5),vec3(0,1,0), 1, 1.5, color3(0.2,0.18,0.3)), trans));
