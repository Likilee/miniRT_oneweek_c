...
int	main(void)
{
	...
	objects = object(LIGHT, light(point3(6, 3, -0.5), color3(100, 100, 100)));
	oadd(&objects, object(LIGHT, light(point3(-2, -2, -0.5), color3(13, 13, 13))));
	...
	// oadd(&objects, object(CY, cylinder(point3(0.5,-2,-2.2),vec3(0,1,0), 1, 1.5, color3(0.2,0.18,0.3))));
