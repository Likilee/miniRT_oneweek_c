...
int	main(void)
{
	...
	trans = transform(vec3(90,0,0), vec3(0,0,0));
	// oadd(&objects, object(SP, sphere(point3(0, 0, 0), 0.5, color3(0.5, 0.3, 0.3)),  trans));
	oadd(&objects, object(CY, cylinder(point3(-2,-0.5,-2),vec3(0,0,1), 1, 1, color3(0.2,0.18,0.3)), trans));
