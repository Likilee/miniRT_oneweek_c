...
int	main(void)
{
	...
	oadd(&objects, object(CB, cube(point3(-2, 2, -4), 2, diffuse, checkered), NULL));
	// oadd(&objects, object(SQ, square(point3(0, 0, -5), vec3(0, 0, 1), 5, diffuse), rotate_sq));
	oadd(&objects, object(CY, cylinder(point3(0.6, 0, -3),vec3(0,1,0), 1, 1, diffuse, rainbow_normal), rotate_cy));
