...
void		record_cylinder(t_cylinder *cy, t_ray *ray, t_hit_rec *rec, double t);
...
void		object2world_rec(t_hit_rec *rec, t_vec3 *offset, t_matrix44 *r, t_matrix44 *r_n);
...
t_color3	direct_lighting_point(t_objects *objs, t_light *light, t_ray *r, t_hit_rec *rec);
